...
var _fellowship = __webpack_require__(329);

var _math = __webpack_require__(330);

var _math2 = _interopRequireDefault(_math);

var _animal = __webpack_require__(331);
...
console.log(_fellowship.total);
// console.log(array_with_nums[1])
var sum = (0, _math.add)(3, 4);
console.log("suma 3 i 4 to " + sum);
var multi = (0, _math2.default)(3, 4);
console.log(multi);

var king = new _animal2.default("Mufasa", 190);
...
var simba = new Lion("Simba", 186, "tawny");
simba.hello();
console.log(simba);
...
var m = Calculator.multiplication(5, 7);
console.log(m);

var ad = Calculator.adding(2, 4);
console.log(ad);
...
function Wizard(name, house, pet) {
	...
	this.greet = function () {
		return "Hi, I am " + _this2.name + " and I am from " + _this2.house;
	};
}
...
Wizard.prototype.info = function () {
	return "My pet's name is " + this.pet_name;
};
var harry = new Wizard("Harry Potter", "Gryffindor", "owl");
console.log(harry.greet());
harry.pet_name = "Hedwig";
console.log(harry);
var ron = new Wizard("Ron Weasley", "Gryffindor", "rat");
console.log(ron);
...
var tablica = [1, 2, 3, 4, 5, 5, 5, 6, 6, 6, 7, 8, 8, 8];
var tablica2 = new Set(tablica);
...
try {
	for (var _iterator = tablica2.values()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
		var el = _step.value;
...
var rand = "qweweeooeptorlckjlvjflkhgrlhipotih[pfdopfdosd;lk;lvkj;lhlkjlkjcl;kd;og[phoh[";
var arrRand = rand.split("");
var unique = new Set(arrRand);
console.log(unique.has("q"));

var contains = function contains(word, letter) {
	var letters = word.split("");
	var lettersSet = new Set(letters);
...
try {
	for (var _iterator2 = mapArr.entries()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
var str = "qwertyuioplkjhfdsazxcvbnmnbvcxzlkjhgdesaqwertyyuuujjkjdsdsrieriotoffhdhjkfgflkfkdskdk";
var strMap = new Map();
console.log(strMap);
...
var add_full = addSuffix("full");
console.log(add_full);
var seen = add_full("beauty");
console.log(seen);
...
var product = function product(a) {
	return function (b) {
		return a * b;
	};
};
...
var budget = function budget() {
	...
	var withdraw10 = function withdraw10() {
		return changeBal(-10);
	};
...
var fellowship = ["Frodo", "Samwise", "Gandalf"];
var total = fellowship.length;
...
var Animal = function () {
	...
	_createClass(Animal, [{
		key: "hello",
		value: function hello() {
			console.log("Hi I am " + this.name + " and I am " + this.height + " tall");
		}
	}]);
